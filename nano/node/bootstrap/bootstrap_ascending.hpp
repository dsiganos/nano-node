...
namespace bootstrap
{
	...
	public:
		...
		private:
			nano::account random ();
			// A forwarded account is an account that has recently had a new block inserted or has been a destination reference and therefore is a more likely candidate for further block retrieval
